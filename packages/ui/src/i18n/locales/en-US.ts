...
const enUS: Record<string, string> = {
  ...
  "settings.mobilePairing.title": "Mobile Pairing",
  "settings.mobilePairing.description":
    "Scan the QR code with the ZCode Harmony app to bind your phone to this server, then approve tasks and review changes on the go.",
  "settings.mobilePairing.generate": "Generate pairing QR code",
  "settings.mobilePairing.regenerate": "Regenerate",
  "settings.mobilePairing.issuing": "Generating…",
  "settings.mobilePairing.scanHint": "Scan with the ZCode Harmony app to bind",
  "settings.mobilePairing.expiresInSeconds": "QR code expires in {seconds}s",
  "settings.mobilePairing.expired": "QR code expired, please regenerate",
  "settings.mobilePairing.fingerprint": "Certificate fingerprint: ",
  "settings.mobilePairing.devices": "Paired devices",
  "settings.mobilePairing.noDevices": "No paired devices yet",
  "settings.mobilePairing.refresh": "Refresh",
  "settings.mobilePairing.revoke": "Revoke",
  "settings.mobilePairing.revokeConfirm": "Confirm revoke?",
  "settings.mobilePairing.desktopUnavailable":
    "Mobile pairing is currently available in web mode (zcode --web) only; the desktop app entry will arrive in a later release.",
  "settings.mobilePairing.loadError": "Operation failed: {message}",
