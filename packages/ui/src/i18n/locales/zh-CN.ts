...
const zhCN: Record<string, string> = {
  ...
  "settings.mobilePairing.description":
    "用 ZCode Harmony App 扫描二维码，把手机绑定到本 Server，随时批准任务与查看变更。",
  "settings.mobilePairing.generate": "生成配对二维码",
  "settings.mobilePairing.regenerate": "重新生成",
  "settings.mobilePairing.issuing": "正在生成…",
  "settings.mobilePairing.scanHint": "使用 ZCode Harmony App 扫码完成绑定",
  "settings.mobilePairing.expiresInSeconds": "二维码 {seconds} 秒后过期",
  "settings.mobilePairing.expired": "二维码已过期，请重新生成",
  "settings.mobilePairing.fingerprint": "证书指纹：",
  "settings.mobilePairing.devices": "已配对设备",
  "settings.mobilePairing.noDevices": "暂无已配对设备",
  "settings.mobilePairing.refresh": "刷新",
  "settings.mobilePairing.revoke": "吊销",
  "settings.mobilePairing.revokeConfirm": "确认吊销？",
  "settings.mobilePairing.desktopUnavailable":
    "移动端配对目前仅在 Web 模式（zcode --web）下可用，桌面应用入口将随后续版本提供。",
  "settings.mobilePairing.loadError": "操作失败：{message}",
